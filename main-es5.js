    ...
    var ReviewComponent = /*#__PURE__*/function () {
      ...
      _createClass(ReviewComponent, [{
        ...
        value: function onSectionChange(element) {
          ...
          element.target.classList.remove('border-secondary'); // for (element of element.target.children) {
